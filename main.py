...
user_df.to_csv('output_data/notclean_user_data.csv')
# clean user_data
clean_user_df = data_cleaner.clean_user_data(user_df)
clean_user_df.to_csv('output_data/clean_user_data.csv')
...
credit_card_df.to_csv('output_data/notclean_credit_card_data.csv')
# clean card data
clean_credit_card_df = data_cleaner.clean_card_data(credit_card_df)
clean_credit_card_df.to_csv('output_data/clean_credit_card_data.csv')
# Send to data_base
...
stores_df.to_csv('output_data/notclean_stores_data.csv')
# clean store data and upload to db
clean_stores_df = data_cleaner.clean_store_data(stores_df)
clean_stores_df.to_csv('output_data/clean_stores_data.csv')
# Send to db
...
data_extractor.extract_from_s3('s3://data-handling-public/products.csv',
                             filename = 'output_data/notclean_products.csv')
# clean weights column and products data
products_df = pd.read_csv('output_data/notclean_products.csv')
...
clean_products_df.to_csv('output_data/clean_products_data.csv')
# send to db
